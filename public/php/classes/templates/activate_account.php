    ...
    >
        ...
        <tr>
            <td style="padding: 30px 25px 20px 25px;">
                ...
                >
                    Thank you for registering your account on website 
                    <a 
                        href="<?= $website ?? '' ?>" 
                ...
                <p 
                    style="font-size: 18px; font-weight: 500; text-align: center; margin: 0 0 15px 0; 
                        line-height: 24px; color: #555555; font-family: 'Roboto', Arial, sans-serif;"
                >
                    Before you will be able to log in you need to activate your account.
                </p>
                ...
                <p 
                    style="font-size: 18px; font-weight: 500; text-align: center; margin: 0 0 20px 0; 
                        line-height: 24px; color: #555555; font-family: 'Roboto', Arial, sans-serif;"
                >
                    You can do it by clicking link below:
                </p>
                ...
                >
                    <a 
                        href="<?= $website ?? '' ?>/?user_id=<?= $userId ?? '' ?>&auth_reg=<?= $authReg ?? '' ?>" 
